var dadosPort = {
    'objective': [
        {
            'titulo':'App Store - Store / Space',
            'descricao': 'Web-based storefront application with over 8,000 purchases, developed with React.js using Context API, Styled Components, Ant Design, and single tests on React Testing Library. Built relying on technical documentations to ensure a robust, efficient, and high performance app.',
            // 'descricao':'Aplicação web com mais de 8.000 ativações, desenvolvida em React.js com uso de Context API, Styled Components, Ant Design e testes unitários em React Testing Library. A solução conta com integrações de documentações técnicas para assegurar uma aplicação robusta, eficiente e de alta performance.',
            'link':'https://store.eduzz.com/',
        ...
        {
            'titulo':'Backoffice - Store / Space',
            'descricao':'Web-based application to allow the users complete management of the app store, including account creation, setting access permissions and other admin features.',
            // 'descricao':'Aplicação web para gerenciamento completo de usuários da loja de aplicativos, incluindo criação de contas, definição de permissões de acesso e outras funcionalidades de administração.',
            'link':'https://space-bo.store.eduzz.com',
            'linkDesc':'Check out the application'
        }
    ],
    'playerum': [
        {            
            'titulo':'Neoenergy - Environment Course',
